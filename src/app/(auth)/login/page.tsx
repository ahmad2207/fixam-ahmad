        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-7 sm:p-9">
            ...
            <div className="text-center mb-7">
              ...
              <p className="text-sm text-gray-500 mt-1">Sign in to your Fixam Africa account</p>
            </div>
            ...
            <button
              ...
              className="w-full h-12 flex items-center justify-center gap-3 border-2 border-gray-200 hover:border-gray-300 bg-white hover:bg-gray-50 rounded-xl font-semibold text-sm text-gray-700 transition-all"
            >
              <GoogleIcon />
