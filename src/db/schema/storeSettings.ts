...
export const storeSettings = pgTable('store_settings', {
  ...
  bankName2: text('bank_name_2'),
  accountNumber2: text('account_number_2'),
  accountName2: text('account_name_2'),
  ...
  notifyPaymentConfirmed: boolean('notify_payment_confirmed').default(false),
